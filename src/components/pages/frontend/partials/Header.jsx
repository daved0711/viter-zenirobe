...
const Header = () => {
  ...
  return (
    <header className={`${scrollPosition > 150 ? "bg-white" : ""
      ...
      <div className="container">
        <div className={`${scrollPosition > 150 ? "!text-black" : ""} flex justify-between items-center py-4  md:hover:text-black`}>
         ...
         <button
          ...
          >
            <span
              className={`${scrollPosition === 0 ? "bg-white" : "bg-black"} ${isOpen && "!bg-black"}`}
            ></span>
            <span
              className={`${scrollPosition === 0 ? "bg-white" : "bg-black"} ${isOpen && "!bg-black"}`}
            ></span>
          ...
          <nav className={`fixed md:static w-full h-screen md:h-auto top-[61px] left-0 bg-white md:bg-transparent md:w-auto ${isOpen ? "text-black block" : "hidden md:block"}`}>
            ...
            <Link to="/"className="md:hidden py-4 border-y border-black translate-x-[50px] block translate-y-[90px] w-[75%]">Account</Link></nav>
